...
/**
 * The ElevensBoardLabAssessment class represents the board in a game of Elevens.
 */
public class ElevensBoardLabAssessment extends Board{
	...
	/**
	 * Creates a new <code>ElevensBoardLabAssessment</code> instance.
	 */
	public ElevensBoardLabAssessment() {
...
//		deck.shuffle();
//		dealMyCards();
		System.out.println("Name: Edward Li \n Period: 4 \n Date: 3/28/18 \n Computer 24");
	}
